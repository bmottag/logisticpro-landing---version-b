...
export const AboutUsSection = (): JSX.Element => {
  return (
    <div className="w-full max-w-[500px] sm:max-w-[600px] md:max-w-[650px] lg:max-w-[700px] xl:max-w-[719px] [font-family:'Encode_Sans',Helvetica] font-normal text-transparent text-[32px] sm:text-[40px] md:text-[52px] lg:text-[68px] xl:text-[80px] text-right tracking-[0] leading-[36px] sm:leading-[44px] md:leading-[56px] lg:leading-[72px] xl:leading-[80px] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">   
      ...
      <p className="[font-family:'Inter',Helvetica] font-bold text-white text-base sm:text-lg md:text-xl leading-[24px] sm:leading-[28px] md:leading-[30px] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:1000ms] text-right mb-3 sm:mb-4">
      ...
      <p className="[font-family:'Inter',Helvetica] font-normal text-white text-base sm:text-lg md:text-xl leading-[24px] sm:leading-[28px] md:leading-[30px] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:1000ms] text-right mb-3 sm:mb-4">
